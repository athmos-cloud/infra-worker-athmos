...
//	var parentIdentifier identifier2.ID
...
//			parentIdentifier = identifier2.FromMap(entry[parentIdentifierKey].(map[string]interface{}))
//		} else {
//			panic(errors.BadRequest.WithMessage("parentIdentifier must be a map[string]interface{}"))
//		}
//	} else {
//		parentIdentifier = identifier2.Empty{}
//	}
