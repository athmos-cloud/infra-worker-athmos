...
func (aws *awsRepository) FindSubnetwork(ctx context.Context, opt option.Option) (*resource.Subnetwork, errors.Error) {
	...
	if err := kubernetes.Client().Client.Get(ctx, types.NamespacedName{Name: req.Name, Namespace: req.Namespace}, awsSubnetwork); err != nil {
...
func (aws *awsRepository) FindAllSubnetworks(ctx context.Context, opt option.Option) (*resource.SubnetworkCollection, errors.Error) {
...
func (aws *awsRepository) CreateSubnetwork(ctx context.Context, subnetwork *resource.Subnetwork) errors.Error {
...
func (aws *awsRepository) UpdateSubnetwork(ctx context.Context, subnetwork *resource.Subnetwork) errors.Error {
...
func (aws *awsRepository) DeleteSubnetwork(ctx context.Context, subnetwork *resource.Subnetwork) errors.Error {
	awsSubnetwork := aws.toAWSSubnetwork(ctx, subnetwork)
...
func (aws *awsRepository) DeleteSubnetworkCascade(ctx context.Context, subnetwork *resource.Subnetwork) errors.Error {
	...
	if vms, err := aws.FindAllVMs(ctx, option.Option{Value: resourceRepo.FindAllResourceOption{Labels: searchLabels}}); !err.IsOk() {
		...
		return aws.DeleteSubnetwork(ctx, subnetwork)
	}
}

func (aws *awsRepository) SubnetworkExists(ctx context.Context, subnetwork *resource.Subnetwork) (bool, errors.Error) {
...
func (aws *awsRepository) toModelSubnetwork(subnet *v1beta1.Subnet) (*resource.Subnetwork, errors.Error) {
...
func (aws *awsRepository) toAWSSubnetwork(ctx context.Context, subnet *resource.Subnetwork) *v1beta1.Subnet {
...
func (aws *awsRepository) toModelSubnetworkCollection(subnetworkList *v1beta1.SubnetList) (*resource.SubnetworkCollection, errors.Error) {
